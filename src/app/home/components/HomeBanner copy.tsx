...
const DEFAULT_BANNERS = [
    {
        heading: 'Power Up for Steel Quality',
        description:
    ...
    {
        heading: 'Innovate Your Steel Process',
        description:
            'Upgrade your steel production with our innovative refractory products, engineered for maximum efficiency and reliability.',
        backgroundImageUrl: "/home/banner2.webp",
    },
    // Add more banner objects as needed
];

const DEFAULT_HEADING = DEFAULT_BANNERS[0].heading;
const DEFAULT_DESCRIPTION = DEFAULT_BANNERS[0].description;
const DEFAULT_BG = DEFAULT_BANNERS[0].backgroundImageUrl;
